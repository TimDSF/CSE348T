...
int n,m,t,d,n2,e[505]; // n2, e[]: graph with only repair shops; 
bool r[505]; // r: repair shop or not
long long dist[505][505],dis2[505]; // dist[][]: Floyd–Warshall on all nodes; dis2[]: distance for new graph 
...
int main(){
    ...
    // n: intersections; m: roads; t: repair shops; d: distance without flat tyres
